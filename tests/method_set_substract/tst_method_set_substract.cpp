...
void method_set_substract::test_empty_empty()
{
    set<int> my_set1;
    set<int> my_set2;

    my_set1.set_substract(my_set2);

    QCOMPARE(my_set1.get_length(), 0);
}

void method_set_substract::test_empty_filled()
{
    set<int> my_set1;
...
void method_set_substract::test_filled_empty()
{
...
void method_set_substract::test_filled_filled()
{
    set<int> my_set1{1, 2, 3, 4, 5};
...
void method_set_substract::test_all_double_values()
{
    set<int> my_set1{1, 2, 3, 4, 5};
    set<int> my_set2{1, 2, 3, 4, 5};
...
void method_set_substract::test_some_double_values()
{
    set<int> my_set1{1, 2, 3, 4, 5};
