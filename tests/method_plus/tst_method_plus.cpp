...
class method_plus : public QObject
{
    Q_OBJECT
...
void method_plus::test_empty_empty()
{
    set<int> my_set1;
    set<int> my_set2;
...
void method_plus::test_empty_filled()
{
    set<int> my_set1;
...
void method_plus::test_filled_empty()
{
...
void method_plus::test_filled_filled()
{
    set<int> my_set1{1, 2, 3, 4, 5};
...
void method_plus::test_all_double_values()
{
    set<int> my_set1{1, 2, 3, 4, 5};
    set<int> my_set2{1, 2, 3, 4, 5};
...
void method_plus::test_some_double_values()
{
    set<int> my_set1{1, 2, 3, 4, 5};
...
QTEST_APPLESS_MAIN(method_plus)

#include "tst_method_plus.moc"
