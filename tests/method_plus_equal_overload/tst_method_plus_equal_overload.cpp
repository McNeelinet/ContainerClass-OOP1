...
void method_plus_equal_overload::test_empty_empty()
{
    set<int> my_set1;
    set<int> my_set2;
...
void method_plus_equal_overload::test_empty_filled()
{
    set<int> my_set1;
...
void method_plus_equal_overload::test_filled_empty()
{
...
void method_plus_equal_overload::test_filled_filled()
{
    set<int> my_set1{1, 2, 3, 4, 5};
...
void method_plus_equal_overload::test_all_double_values()
{
    set<int> my_set1{1, 2, 3, 4, 5};
    set<int> my_set2{1, 2, 3, 4, 5};
...
void method_plus_equal_overload::test_some_double_values()
{
    set<int> my_set1{1, 2, 3, 4, 5};
